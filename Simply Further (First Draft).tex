...
\section*{Background}
Further Mathematics is considered by many to be the easiest of the three maths units you can take at the VCE level. That being said, many students often underestimate further as even simple mistakes can be the difference between a really good mark, and an average mark. In combination with this, Further Mathematics is the second most popular subject in VCE (according to VCAA), so every mark counts. 
